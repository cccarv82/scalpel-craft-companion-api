...
function page(message: string, status: number) {
  ...
  return new Response(
    `<!doctype html><html><head><meta charset="utf-8"><title>Scalpel Craft Companion</title></head><body style="font-family:system-ui;background:#0e0e12;color:#eee;display:flex;align-items:center;justify-content:center;height:100vh;margin:0"><div style="text-align:center;max-width:480px;padding:24px"><h2 style="color:#f0a020">Scalpel Craft Companion</h2><p>${safe}</p><p style="opacity:.6;font-size:14px">You can close this tab.</p></div></body></html>`,
